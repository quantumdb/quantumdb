...
@Slf4j
public class DryRun extends Command {

	@Override
	public Identifier getIdentifier() {
		return new Identifier("dry-run", "Simulates a fork, writes the SQL code to dry-run.sql");
	}
	...
	public void perform(CliWriter writer, List<String> arguments) {
		try {
			...
			writer.write("Simulating a fork from: " + from.getId() + " to: " + to.getId() + "...");
