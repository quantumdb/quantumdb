...
public class JoinTableTest {
	...
	public void testJoinTable() {
		...
		ImmutableMultimap<String, String> expectedSourceColumns = ImmutableMultimap.<String, String>builder()
				.putAll("u", Lists.newArrayList("id", "name"))
				.putAll("a", Lists.newArrayList("address"))
				.build();
